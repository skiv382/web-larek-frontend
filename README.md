Павел, здравствуйте, спасибо за ревью! 

Исправил оба замечания-индексы теперь обновляются правильно, а команды разбил по отдельным файлам. 

Попутно сделал небольшое улучшение UX-теперь модалки открываются в центре экрана без прыжков по странице. Также сделал скроллбар в "полной" корзине немного красивее.

Вопрос если можно: как лучше реализовать маски изображений в карточках товаров? И хочется добавить кнопку "в корзину" внутри модалки товара.
